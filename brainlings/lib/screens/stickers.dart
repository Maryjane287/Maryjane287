...
class StickerAlbum extends StatelessWidget {
  ...
  static int get slots => stickerPool.length;
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        for (var i = 0; i < slots; i++)
                          i < app.stickers.length
                              ? _Sticker(app.stickers[i])
                              : _Empty(),
                      ],
                    ),
                  ),
                ...
                Bubble(
                  app.stickers.isEmpty
                      ? 'Play a game to win your very first sticker!'
                      : 'Wow! Look at all your stickers!',
                ),
              ],
            ),
          ),
    ...
    onTap: () {
      ...
      Voice.say(
        const [
          ...
          'So cool!',
          'Wiggle wiggle!',
        ][widget.emoji.codeUnitAt(0) % 4],
      );
    },
    child: AnimatedBuilder(
      animation: _c,
      builder: (_, c) => Transform.rotate(
        angle: (1 - _c.value) * _c.value * 2.4 * (_c.value < .5 ? 1 : -1),
        child: Transform.scale(
          scale: 1 + (1 - _c.value) * _c.value * 1.2,
          child: c,
        ),
      ),
      child: Container(
        ...
        child: Center(
          child: stickerPool.contains(widget.emoji)
              ? Padding(
                  padding: const EdgeInsets.all(6),
                  child: Art(widget.emoji, size: 60, sticker: true),
                )
